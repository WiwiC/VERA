...
# Source: Tsiartas (2013) - High var = High arousal.
...
INTERPRETATION_RANGES = {
    "speech_rate": [
        ...
        {"max": 160, "label": "optimal", "text": "Optimal pace (Excellent). Easy to follow and engaging.", "coaching": "Excellent pace! You are easy to follow and engaging."},
    ...
    "pause_ratio": [
        ...
        {"max": 0.25, "label": "optimal", "text": "Perfect rhythm (Excellent). Great use of silence for emphasis.", "coaching": "Perfect use of silence. It makes you sound confident and thoughtful."},
    ...
    "pitch_dynamic": [
        ...
        {"max": 6.0, "label": "optimal", "text": "Highly expressive (Excellent). Captivating vocal melody.", "coaching": "Fantastic intonation! Your voice is melodic and captivating."},
    ...
    "volume_dynamic": [
        ...
        {"max": 0.90, "label": "optimal", "text": "Dynamic delivery (Excellent). Great emotional texture.", "coaching": "Great dynamic range. You use volume effectively to convey emotion."},
    ...
    "vocal_punch": [
        ...
        {"max": 20.0, "label": "optimal", "text": "Strong vocal energy (Excellent). Clear, punchy articulation.", "coaching": "Strong vocal presence. Your voice cuts through clearly."},
